...
fun MainScreen(
   ...
   androidx.compose.material.Scaffold (bottomBar = {
        ...
        FloatingActionButton(onClick = {
            onCartClick()
        }, contentColor = Color.White, backgroundColor = colorResource(id= R.color.orange)) {
       ...
       content={paddingValues ->
           Column (modifier=Modifier.fillMaxSize()
            ...
            val viewModel=MainViewModel()
               ...
               LaunchedEffect(Unit) {
                   viewModel.loadPoular().observeForever{
                       popular.clear()
                       popular.addAll(it)
...
fun FoodItem(food: FoodModel, onFoodClick: (FoodModel) -> Unit) {
        ConstraintLayout(modifier = Modifier.wrapContentSize().border(
            3.dp, colorResource(R.color.grey),
            ...
            Text(text = food.title, fontSize = 14.sp,
                fontWeight = FontWeight.Bold,
            ...
            AsyncImage(
                ...
                modifier = Modifier.size(100.dp).constrainAs(image){
    ...
    if(showCategoryLoading){
        ...
        LazyRow (horizontalArrangement = Arrangement.spacedBy(8.dp),
            ...
            items(categories.size) {
                ...
                ConstraintLayout(modifier = Modifier.width(75.dp)
                    .wrapContentHeight().
                    background(
                    ...
                    AsyncImage(
                        ...
                        modifier = Modifier.size(35.dp).constrainAs(image){
...
fun Banner() {
    ConstraintLayout(modifier = Modifier.padding(horizontal = 16.dp, vertical = 16.dp)
        .fillMaxWidth().
        height(150.dp)
        .background(color = Color(0xffffc5ab),
shape = RoundedCornerShape(10.dp)

            )
    ) {
        val (image,title,date,buttonLayout)=createRefs()
        Image(painter = painterResource(R.drawable.image_banner),
            contentDescription = null,
...
fun MyButtomBar(){
    ...
    BottomAppBar (cutoutShape = CircleShape,
        ...
        bottomMenuItemList.forEachIndexed{
            ...
            BottomNavigationItem(selected = (selectedItem==bottomMenuItem.label),
                ...
                }, alwaysShowLabel = true, enabled = true
                )
        }
    }
}
